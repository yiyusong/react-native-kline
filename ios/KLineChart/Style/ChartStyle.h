...
//实时线颜色等
#define ChartColors_realTimeBgColor   Color(0xFFFFFF00)
#define ChartColors_rightRealTimeTextColor   Color(0xFF666F80)
...
#define ChartColors_crossHlineColor   Color(0x1F777777)
